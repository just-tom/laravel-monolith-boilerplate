...
const props = defineProps({
    tokens: {
        type: Array as PropType<ApiTokenData[]>,
        required: true,
    },
...
const managingPermissionsFor = ref<ApiTokenData | null>(null)
const apiTokenBeingDeleted = ref<ApiTokenData | boolean | null>(null)
...
const confirmApiTokenDeletion = (token: ApiTokenData) => {
