...
import ConfirmsPassword from "@/Components/Modals/ModalConfirmsPassword.vue"
...
const props = defineProps({
    requiresConfirmation: Boolean as PropType<boolean>,
})

const enabling = ref<boolean>(false)
const confirming = ref<boolean | undefined>(false)
...
const twoFactorEnabled = computed((): boolean => !enabling.value && usePage<Props>().props.user?.two_factor_enabled)
